...
public class UserService {
	...
	*用户列表(用户组)
	*/
	public List<PageData> listPdPageUser(Map<String, Object> map)throws Exception{
		return (List<PageData>) dao.findForList("UserXMapper.userListPage", map);
	}
	...
	public PageData getCount(Map<String, Object> map)throws Exception{
		return (PageData)dao.findForObject("UserXMapper.getCount", map);
	}
