...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="VideoLearnManage/VideoLearnListPage.do?CurriculumID=${pd.CurriculumID }&CurriculumSeriesID=${pd.CurriculumSeriesID}" method="post" name="residenceForm" id="residenceForm">
			<table>
				<tr>
					<td>
			...
			<a title="返回上一页" href="CurriculumManage/CurriculumListPage.do?CurriculumSeriesID=${pd.CurriculumSeriesID }" class="btn btn-mini btn-info" onclick="" >返回上一页</a>
