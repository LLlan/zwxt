...
<body>
	<form action="CurriculumManage/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		...
		<div id="zhongxin">
		 <h3 style="text-align: center;" ><b>直播介绍</b></h3>
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<td colspan="2" style="height: 100px;">
					<textarea id="editor" name="CurriculumContent" style="height:400px;width: 865px;">${pd.LiveBroadcastContent==null?"":pd.LiveBroadcastContent }</textarea>
				</td>
			</tr>
			<tr>
				<td>
