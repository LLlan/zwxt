...
<body>
	<form action="CurriculumManage/${msg }.do" id="residenceForm" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="CurriculumVideoLength" id="CurriculumVideoLength" value="${pd.CurriculumVideoLength}"/>
		<input type="hidden" name="CurriculumSeriesID" id="CurriculumSeriesID" value="${pd.CurriculumSeriesID}"/>
		<input type="hidden" name="CurriculumType" id="CurriculumType" value="${pd.CurriculumType}"/>
		<div id="zhongxin">
		<table class="table table-striped table-bordered">
			<tr>
				<td>课程类型：</td>
				<td>
				     <select name="CurriculumTypes" id="CurriculumTypes" title="课程类型" disabled="disabled">
			...
			<c:if test="${pd.CurriculumType == '0' }">
				<tr id="1">
					<td colspan="2">文章内容:</td>
				</tr>
				<tr id="2">
					<td colspan="2" style="height: 100px;">
						<textarea id="editor" name="CurriculumContent" style="height:400px;width: 760px;">${pd.CurriculumContent==null?"":pd.CurriculumContent }</textarea>
					</td>
				</tr>
			</c:if>	
			<tr>
