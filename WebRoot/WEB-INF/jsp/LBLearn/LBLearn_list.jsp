...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="LiveBroadcastManage/LBLearnListPage.do" method="post" name="residenceForm" id="residenceForm">
			<table>
				<tr>
					<td>
			...
			<a title="返回上一页" href="LiveBroadcastManage/LiveBroadcastListPage.do" class="btn btn-mini btn-info" onclick="" >返回上一页</a>
			...
			<table style="margin-top: 8px;" id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">观看学员</th>
						<th class="center">直播课程</th>
						<th class="center">已观看直播时长</th>
		...
		<tbody>
				...
				<!-- 开始循环 -->	
				<c:choose>
					<c:when test="${not empty LBLearnList}">
						<c:if test="${QX.cha == 1 }">
						<c:forEach items="${LBLearnList}" var="rlist" varStatus="vs">
							...
							<tr>
								...
								<td class='center'>${rlist.LBLearnLength}</td>
								<%-- <td class='center'>
									<fmt:formatDate type="date" value="${rlist.LBLearnTime}" />
            					</td> --%>
								<%-- <td class='center'>
