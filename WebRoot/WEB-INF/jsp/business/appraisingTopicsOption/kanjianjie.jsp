...
<body>
	<form action="appraisingTopicsOption/${msg }.do" id="residenceForm" method="post" enctype="multipart/form-data">
		...
		<table class="table table-striped table-bordered">
			...
			<tr>
				<b style="text-align: center;"><h3>评优选项简介内容</h3></b>
				<%-- <td style="text-align: center;"><img style="width: 50px;height: 50px;" alt="" src="${pd.PMPhoto }"></td> --%>
			</tr>
			<tr>
				<td colspan="2" style="height: 100px;">
					<textarea id="editor" name="ATOIntroduction" style="height:400px;width: 865px;">${pd.ATOIntroduction==null?"":pd.ATIntroduction }</textarea>
				</td>
			</tr>
			<tr>
				<td>
