...
<body>
	<form  action="bank/${msg }.do" name="menuForm" id="menuForm" method="post" >
		...
		<table class="table table-striped table-bordered">
				...
				<td style="position:relative;">
					...
					<ul class="xuanUl"  title="菜单">
							...
							<c:forEach items="${menuList}" var="menu">
								<li value="${menu.PBLProvinceID }" onclick="yingcs('${menu.PBLProvinceID }')" class="hhh">${menu.PBLProvinceName }</li>
							</c:forEach>
					</ul>
				</td>	
			</tr>
			<tr id="hides">
				<td>党建网所在省份名：</td>
				<td><input type="text" name="PBLProvinceName" id="PBLProvinceName" placeholder="输入党建网所在省份名" value="" title="党建网所在省份名"/></td>
			</tr>
			<tr>
				<td>党建网所在城市名：</td>
				<td><input type="text" name="PBLCityName" id="PBLCityName" placeholder="输入党建网所在城市名" value="" title="党建网所在城市名"/></td>
			</tr>
			<tr>
				<td>党建网名称：</td>
				<td><input type="text" name="PBANetName" id="PBANetName" placeholder="输入党建网名称" value="" title="党建网名称"/></td>
			</tr>
			<tr>
				<td>党建联盟党建网链接URL：</td>
				<td><input type="text" name="PBANetURL" id="PBANetURL" placeholder="输入党建联盟党建网链接URL" value="" title="党建联盟党建网链接URL"/></td>
			</tr>
			<!-- <tr>
