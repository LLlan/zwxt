	...
	<form action="InterFile/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<%-- <tr>
				...
				<td>
					<select id="selected">
						  	<option value ="">顶级标题</option>
						 <c:forEach items="${fileTypeList}" var="fileType">
						  	<option value ="${fileType.InterFileName }">${fileType.InterFileName }</option>
						 </c:forEach>
					</select>
				</td>	
			</tr> --%>
			<tr>
				<td>标题:</td>
				<td>
					<input type="text" name="InterFileName" id="InterFileName" value="${pd.InterFileName }" placeholder="标题"/>
				</td>
			</tr>
			<tr>
				<td>副标题:</td>
				<td>
					<input type="text" name="InterFileFuName" id="InterFileFuName" value="${pd.InterFileFuName }" placeholder="副标题"/>
				</td>
			</tr>
			<tr>
				<td colspan="2">简介:</td>
			...
			<tr>
				<td colspan="2" style="height: 100px;">
					<textarea id="editor" name="InterFileIntroduction" style="height:400px;width: 865px;">${pd.InterFileIntroduction==null?"":pd.InterFileIntroduction }</textarea>
				</td>
			</tr>
